...
multi_ai_agent = Agent(
    ...
    model=Groq(id="llama3-groq-70b-8192-tool-use-preview", api_key=groq_api_key),
    # instructions=["You are a professional financial web search agent.", "Always include sources", "Use tables to display data"],
    show_tool_calls=True,
    markdown=True,
)

multi_ai_agent.print_response(
    "Summarize financial analysis recommendations for DELL stock"
)

# websearch_agent.print_response(
#     "Summarize financial analysis recommendations for NVDA stock"
# )